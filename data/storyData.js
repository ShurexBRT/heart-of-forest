export const QUEST_DEFS = {
  wake_hearthroot: {
    ...
    description: "Answer the pulse beneath Ayla's silent shrine. Before the road asks for violence, the Hearthroot needs proof that this keeper still remembers how to care.",
  ...
  first_moonleaf: {
    ...
    description: "The forest will not follow another keeper who only arrives with a weapon. Restore one living rhythm at home: plant Moonleaf, water it, rest once, and harvest it at dawn.",
    autoActivateSceneId: "ayla_homestead",
  ...
  thorn_at_gate: {
    ...
    description: "The first harvest carries a thorn-mark that does not belong in the garden. Follow the Hearthroot's pain beyond the gate and clear the creatures driven onto the old road.",
  ...
  brew_before_blood: {
    ...
    description: "The road creatures carry splinters of Rootwarden's broken oath. Return with ironbark and Moonleaf, then brew Barkskin before entering the thorn-crowned ruins.",
    autoActivateSceneId: "ayla_homestead",
  ...
  first_rootwarden: {
    ...
    description: "Enter Mossy Ruins with Barkskin prepared. Read the open lanes in the guardian's thorn crown and release Heartwood from an oath that outlived its purpose.",
