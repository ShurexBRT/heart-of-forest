export const QUEST_DEFS = {
  wake_hearthroot: {
    ...
    completeToast: "Hearthroot wakes. Plant Moonleaf next: the eastern gate answers care before combat.",
  ...
  first_moonleaf: {
    ...
    completeToast: "First Moonleaf harvested. The gate opens toward Whispering Woods.",
    objectives: [
  ...
  thorn_at_gate: {
    ...
    description: "The first harvest carries a thorn-mark that does not belong in the garden. Follow it into Whispering Woods, read the driven creatures' tells, and make the first road safe enough to cross.",
    ...
    completeToast: "The old road quiets. Barkskin Draught is known at the Homestead cauldron.",
  ...
  brew_before_blood: {
    ...
    description: "The road splinters point to Rootwarden's broken oath. Brew Barkskin with Moonleaf and ironbark: it softens thorn damage, but it does not replace learning the boss patterns.",
    autoActivateSceneId: "ayla_homestead",
    ...
    completeToast: "Barkskin is prepared. Mossy Ruins opens; Rootwarden's crown still has to be read.",
  ...
  sealed_reliquary: {
    ...
    description: "Orras believes two old waystone seals can open the buried vault beneath the ruins. One waits near Whispering Woods' east road; the other sits beside Moonlit Marsh's north plank bridge.",
    giverId: "orras",
    sceneId: "mossy_ruins",
    ...
    objectives: [
      { key: "waystoneSealsRecovered", label: "Recover both visible Waystone Seals", required: 2 },
    ],
  },
  depths_of_memory: {
    id: "depths_of_memory",
  ...
  scarroot_homecoming: {
    ...
    description: "Recover the first keeper's living memory from Hollowheart Court and return it to Bram. This closes Scarroot's wound and opens the Rootsong Rite: Ayla's choice of one Signature ultimate.",
    giverId: "bram",
    sceneId: "blighted_woods",
    ...
    startToast: "Carry the first keeper's memory back to Bram. Scarroot needs a choice, not another command.",
    completeToast: "Rootsong Rite unlocked. Press N, choose one final ULT talent, build 100 Heart Charge, then cast it with R.",
    objectives: [
    ...
    dialogue: {
      ...
      complete: [
        ...
        "The root is free now, and it recognizes your path. This is the Rootsong Rite.",
        "Open Talents with N and choose one final ULT: Heartwood Tempest for the staff, Verdant Nova for magic, or Awaken the Grove for roots and healing.",
        "After you learn one, build Heart Charge in combat. When the HUD ring says READY, press R to cast your Signature.",
      ],
    },
  },
  smallest_grove: {
